...
const meta = {
  title: 'Joy Miki - Desenvolvedor Front-End',
  description:
  ...
  render() {
    return (
      <Html lang="pt-BR">
        <Head>
          <meta charSet="utf-8" />
          <meta name="author" content="Joy Miki" />
          ...
          <meta name="copyright" content="Joy Miki 2023" />
          ...
          <meta property="og:site_name" content="Joy Miki" />
